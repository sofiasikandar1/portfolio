...
The data represents explains quite well. The happiness score is observed over two years, and then relationships between happiness score and different variables are observed, i.e crime levels, cost of living, and gdp. 

b.	Why do they explain well or poorly? 	
They are represented well because the variables and data are thorough, complex, and analytical. 

c.	What other variables might better explain happiness? Why?  
Other variables such as birth rate could have explained levels of happiness. A baby boom during a certain time period can significantly boost or heavily decrease happiness score. 

###A summary of what you have learned from this exploratory analysis: 
  
(i)	List major insights from this analysis
The happiness score between 2015 and 2017 did not vary signficantly among countries. 
Some countries improved slightly or signficantly decreased in happiness score.


(ii) Briefly discuss limitations of the analysis
The limitations of the analysis is within the data. The data is not the most recent. There is data from 2015 and 2017. The data from 2016 is missing, so if there is a big difference in the significant data such as happiness score or rank it would be hard to explain. This also makes it difficult to explain or identify any fluctations. 

(iii)	Briefly discuss what additional data and analysis may be needed
It would help to have data from 2016 so that if there are any fluctations in happiness score or rank, it can clearly be shown. The happiness score fluctations can clearly be represented by the three covariations we observed, such as crime level, cost of living, and gdp. This could have been down for a few years and then just coming back up for example. 
